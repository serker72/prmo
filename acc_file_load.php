...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(4, $fmi['acceptance_id'], new AccFileItem(4));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл реализации',NULL,200, NULL,SecStr('файл '.$fmi['orig_name'].' для реализации № '.  $user['id'].$_folder_desrc),$user['id']);
