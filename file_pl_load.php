...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл из раздела —правочна€ информаци€',NULL,29, NULL,SecStr('файл '.$fmi['orig_name'].$_folder_desrc),$user['id']);	
