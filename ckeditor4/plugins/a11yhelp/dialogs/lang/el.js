...
{name:"",items:[{name:"  ",legend:" ${undo}"},{name:"  ",legend:" ${redo}"},{name:"   ",legend:" ${bold}"},{name:"   ",legend:" ${italic}"},{name:"  ",legend:" ${underline}"},{name:"  ",legend:" ${link}"},{name:"   ",legend:" ${toolbarCollapse}"},{name:"     ",legend:" ${accessPreviousSpace}            ,  :    .           . "},
{name:" w w z ",legend:" ${accessNextSpace}   ete         ,  :    .         . "},{name:"  ",legend:" ${a11yHelp}"}]}]});