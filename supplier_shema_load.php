...
if($fmi['folder_id']==0){
	$_folder_desrc='';
	 ...
	 $_ff=new FileDocFolderItem(3, $fmi['user_d_id'], new Supplier_Sh_Item(3));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл схемы проезда к контрагенту',NULL,87, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].' '.$user['full_name'].$_folder_desrc),$user['id']);
