...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(4, $fmi['bill_id'], new BillFileItem(4));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл исходящего счета',NULL,93, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].$_folder_desrc),$user['id']);
