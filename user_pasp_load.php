...
$_fmi=new UserPasportItem; // ContractItem;
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл документов сотрудника',NULL,119, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['login'].' '.$user['name_s']),$user['id']);	
