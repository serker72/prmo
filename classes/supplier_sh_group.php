...
class Supplier_Sh_Group extends AbstractFileDocFolderGroup {
	...
	protected function init($id){
		...
		$this->storage_path=ABSPATH.'upload/files/supplier_shema_file/';	
	}
	*/
	...
	protected function init($id, $doc_id, $folder_instance){
		...
		$this->pagename='supplier_shema.php';	
		$this->vis_name='is_shown';	
		$this->subkeyname='user_d_id';
			
		$this->storage_id=$id;	
		$this->storage_name='storage_id';	
		$this->storage_path=ABSPATH.'upload/files/supplier_shema/';	
