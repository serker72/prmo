...
class Propis{
	...
	function propis($rub){
$dop0 = Array("рублей","тыс€ч","миллионов","миллиардов");
$dop1 = Array("рубль","тыс€ча","миллион","миллиард");
$dop2 = Array("рубл€","тыс€чи","миллиона","миллиарда");
$s1 = Array("","один","два","три","четыре","п€ть","шесть","семь","восемь","дев€ть");
