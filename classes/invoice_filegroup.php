...
class InvoiceFileGroup extends AbstractFileDocFolderGroup {
	...
	protected function init($id, $doc_id, $folder_instance){
		...
		$this->tablename_folder='invoice_file_folder';
		$this->doc_id=$doc_id;
	...
	protected function init($id){
		...
		$this->storage_id=$id;	
		$this->storage_name='storage_id';	
		$this->storage_path=ABSPATH.'upload/files/accs/';	
	}
