...
class BillPayInSync extends AbstractItem{
		...
		if($perfom_check){
			...
			if($summ_by_payed>=$summ_by_cost){
				...
				if($bill_item['is_in_buh']==0){
					...
					$log->PutEntry(NULL,'автоматическое утверждение наличия счета в бухгалтерии на основании 100% оплаты',NULL,634,NULL,' счет № '.$bill_item['code'].': утверждено наличие счета в бухгалтерии на основании 100% оплаты',$bill_id);
				...
				if($bill_item['is_in_buh']==1){
					...
					$log->PutEntry(NULL,'автоматическое снятие наличия счета в бухгалтерии на основании остутствия 100% оплаты',NULL,635,NULL,' счет № '.$bill_item['code'].': снято наличие счета в бухгалтерии на основании остутствия 100% оплаты',$bill_id);
