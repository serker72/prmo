...
// группа поступлений
class AccInGroup extends AbstractAccGroup {
	...
	protected function init(){
		...
		$this->_posgroup=new AccInPosGroup;
		
		$this->can_unconfirm_object_id=722;
		$this->can_unconfirm_object_inv_id=672;
		
		$this->_auth_result=NULL;
		
		$this->_view=new Acc_In_ViewGroup;
	}
