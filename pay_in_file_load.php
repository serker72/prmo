...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(3, $fmi['payment_id'], new PayInFileItem(3));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл входящей оплаты',NULL,678, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].$_folder_desrc),$user['id']); 
