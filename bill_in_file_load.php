...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(3, $fmi['bill_id'], new BillInFileItem(3));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл входящего счета',NULL,613, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].$_folder_desrc),$user['id']);
