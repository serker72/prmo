<?php
////////////////////////////////////////////////////////////////////
//создан для устранения конфликта классов с клиентской частью сайта
class PageNavigatorKri_{
	//data members
	private $pagename;
	private $totalpages;
	...
	private $inactivespanname ='inactivelink';
	private $pagedisplaydivname = "totalpagesdisplay";
	private $linkclassname='pageslink';
...
////////////////////////////////////////////////////////////////////
 ...
 ////////////////////////////////////////////////////////////////////
  public function Setlinkclassname($name){
  	$this->linkclassname=$name;
  } 
...
////////////////////////////////////////////////////////////////////
	private function createLink($offset, $strdisplay ){
		...
		$strtemp.= "$this->params\" class=\"$this->linkclassname\">$strdisplay</a>\n";
		return $strtemp;
	}
////////////////////////////////////////////////////////////////////	
