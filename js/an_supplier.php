...
if($_GET['term']) 	{
	...
	$sql='select * from supplier where ((is_org=0 and org_id="'.$result['org_id'].'") or (is_org=1 and id<>"'.$result['org_id'].'")) and is_active=1 and full_name like "%'.iconv("utf-8","windows-1251",SecStr($_GET['term'])).'%" ';
	//echo $sql;
