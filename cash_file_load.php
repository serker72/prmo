...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(1, $fmi['payment_id'], new CashFileItem(1));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл расхода наличных',NULL,833, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].$_folder_desrc),$user['id']); 
