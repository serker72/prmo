<?php
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry( $result['id'],'добавил файл документов сотрудника',NULL,775,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$sup_id);
