<?php
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry( $result['id'],'добавил файл учредительных документов контрагента',NULL,87,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$sup_id);
