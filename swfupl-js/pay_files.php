<?php
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry( $result['id'],'добавил файл исходящей оплаты',NULL,93,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$ai['bill_id']);
		
		
		$log->PutEntry( $result['id'],'добавил файл исходящей оплаты',NULL,274,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$ai['id']);
