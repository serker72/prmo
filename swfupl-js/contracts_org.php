<?php
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry( $result['id'],'добавил файл учредительных документов организации',NULL,143,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$sup_id);
