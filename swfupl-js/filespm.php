...
/*	if(!$au->user_rights->CheckAccess('w',561)){
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry($result['id'],'добавил файл в раздел Файлы и документы - Файлы +/-',NULL,561,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$code);
