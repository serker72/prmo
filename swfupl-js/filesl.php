...
/*	if(!$au->user_rights->CheckAccess('w',557)){
	...
	*/
	...
	if(isset($_FILES['Filedata'])){
		...
		$log->PutEntry($result['id'],'добавил файл в раздел Файлы и документы - Письма',NULL,557,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])),$code);
