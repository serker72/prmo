...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(4, $fmi['payment_id'], new PayFileItem(4));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл исходящей оплаты',NULL,267, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].$_folder_desrc),$user['id']); 
