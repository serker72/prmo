...
$_fmi=new Sched_HistoryFileItem;
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл задачи', NULL, 903, NULL,SecStr('файл '.$fmi['orig_name'].' для заметки '.  $user['id'].' '.$_folder_desrc),$user['id']);
