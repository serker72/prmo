...
//посмотреть может- сотрудник, имеющий право 117
...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(3, $fmi['user_d_id'], new ContractOrgItem(3));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл учредительных документов организации',NULL,117, NULL,SecStr('файл '.$fmi['orig_name'].' для '.  $user['code'].' '.$user['full_name'].$_folder_desrc),$user['id']);
